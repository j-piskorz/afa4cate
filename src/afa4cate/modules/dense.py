...
from afa4cate.modules.spectral_norm import spectral_norm_fc
...
class Activation(nn.Module):
    def __init__(
        ...
        self.op = nn.Sequential(
            ...
            # Conditional activation function logic
            nn.LeakyReLU(negative_slope=negative_slope) if negative_slope >= 0.0 else 
            nn.Sigmoid() if negative_slope == -100.0 else nn.ELU(),
